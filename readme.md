...
## How to use
Paste the [serverID and the channelID](https://support.discord.com/hc/en-us/articles/206346498-Where-can-I-find-my-User-Server-Message-ID-) that you want to scrap for in config.json then start the program running `node start` in the directory. Login with your account manually, sit down and drink a cup of coffee ☕.  
